            ...
            <div class="row px-xl-5">
                <div class="col-lg-4 mb-30">
                    <div class="book-detail-img" data-ride="carousel">
                        <img class="book-detail" src="{{ $book->book_photo }}" alt="Image" onerror="this.src='{{ asset('storage/books/default.png') }}'">
                    </div>
                </div>
                ...
                <div class="col-lg-8 h-auto mb-30">
                    <div class="h-100 bg-light p-30">
                        ...
                        <div class="author text-dark mb-2">
                            <strong>Yazar:</strong> <a href="" class="text-dark">
